  ...
  private loadTranslations(): void {
    ...
    this.translations.ar = {
      ...
      admin: {
        ...
        scannerOn: 'السكانر مُفعّل',
        scannerOff: 'تفعيل السكانر',
        scanBarcode: 'امسح الباركود هنا...',
        scannerHint: 'وجّه السكانر واضغط Enter',
        customers: 'الزبائن',
  ...
  exportExcel: 'تصدير إكسل',
    ...
    this.translations.en = {
      ...
      admin: {
        ...
        scannerOff: 'Enable Scanner',
        scanBarcode: 'Scan barcode here...',
        scannerHint: 'Point scanner and press Enter',
        customers: 'Customers',
